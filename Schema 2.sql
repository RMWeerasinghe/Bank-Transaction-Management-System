...
INSERT INTO `atm` VALUES (1,'Colombo Fort','300'),(2,'Negombo','302'),(3,'Negombo','302'),(4,'Nugegoda','302'),(5,'Kelaniya','303'),(6,'Kelaniya','304'),(7,'Grandpass','304'),(8,'Kollupitiya','305'),(9,'Kollupitiya','306'),(10,'Bambalapitiya','300'),(11,'Ahangama','301');
...
CREATE TABLE `atm_transaction` (
  ...
  KEY `atm_id_atm_idx` (`atm_id`),
  KEY `atm_transaction_fk_1` (`account_no`),
  CONSTRAINT `atm_id_atm` FOREIGN KEY (`atm_id`) REFERENCES `atm` (`atm_id`),
  CONSTRAINT `atm_transaction_fk_1` FOREIGN KEY (`account_no`) REFERENCES `account` (`account_no`),
...
INSERT INTO `atm_transaction` VALUES (10001,1810015001,11,25000.00,'2022-11-24 07:08:55','deposit'),(10002,1810015009,6,10000.00,'2022-11-24 13:15:50','withdrawl'),(10003,8008024001,9,40000.00,'2022-11-24 14:20:58','deposit'),(10004,1810015005,2,38000.00,'2022-11-24 17:15:50','deposit'),(10005,8008024001,10,1000.00,'2023-01-12 08:37:45','withdrawl'),(10006,8008024001,10,1000.00,'2023-01-12 08:50:39','deposit'),(10007,8008024001,10,1000.00,'2023-01-12 10:09:22','deposit');
...
CREATE TABLE `branch_manager` (
  ...
  PRIMARY KEY (`branch_code`),
  KEY `branch_manger_emp_id` (`employee_id`),
  CONSTRAINT `branch_manager_brach` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`),
  CONSTRAINT `branch_manger_emp_id` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=340011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `current_account` (
  ...
  PRIMARY KEY (`account_no`),
  KEY `current_branch_idx` (`branch_code`),
  KEY `current_account_ibfk_2_idx` (`customer_id`),
  CONSTRAINT `current_account_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `current_branch` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `current_account` VALUES (8008024001,'302',833000.00,340002),(8008024002,'304',217000.00,340007);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group2`@`%`*/ /*!50003 TRIGGER `current_account_AFTER_INSERT` AFTER INSERT ON `current_account` FOR EACH ROW BEGIN
	insert into account values (new.account_no,'current');
END */;;
DELIMITER ;
...
CREATE TABLE `employee` (
  ...
  KEY `branch_code` (`branch_code`)
) ENGINE=InnoDB AUTO_INCREMENT=2000010 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fixed_deposit` (
  ...
  `customer_id` int DEFAULT NULL,
  `branch_code` varchar(4) DEFAULT NULL,
  `savings_acc_no` int DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  ...
  PRIMARY KEY (`fd_id`),
  KEY `fixed_deposit_ibfk_2_idx` (`branch_code`),
  KEY `fixed_deposit_ibfk_1_idx` (`customer_id`),
  KEY `fixed_deposit_ibfk_3_idx` (`savings_acc_no`),
  CONSTRAINT `fixed_deposit_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `fixed_deposit_ibfk_2` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`),
  CONSTRAINT `fixed_deposit_ibfk_3` FOREIGN KEY (`savings_acc_no`) REFERENCES `savings_account` (`account_no`)
) ENGINE=InnoDB AUTO_INCREMENT=200406 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `individual_customer` (
  ...
  `nationality` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`customer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=340005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15100404 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loan_application` (
  ...
  KEY `loan_application_ibfk_1_idx` (`branch_code`),
  KEY `loan_application_ibfk_2` (`customer_id`),
  KEY `loan_application_ibfk_3` (`employee_id`),
  CONSTRAINT `loan_application_ibfk_1` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`),
  CONSTRAINT `loan_application_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `loan_application_ibfk_3` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`),
  CONSTRAINT `loan_application_chk_1` CHECK ((`status` in (_utf8mb4'pending',_utf8mb4'approved')))
) ENGINE=InnoDB AUTO_INCREMENT=11203 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loan_installment` (
  ...
  KEY `loan_installment_ibfk_1_idx` (`loan_no`),
  KEY `loan_installment_ibfk_2_idx` (`customer_id`),
  CONSTRAINT `loan_installment_ibfk_1` FOREIGN KEY (`loan_no`) REFERENCES `loan` (`loan_no`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `loan_installment_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `loan_installment_chk_1` CHECK ((`status` in (_utf8mb4'paid',_utf8mb4'not paid')))
) ENGINE=InnoDB AUTO_INCREMENT=9005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `loan_installment` VALUES (9001,15100401,1000000.00,'2022-11-08','2022-11-05','paid',340001),(9002,15100402,2000000.00,'2022-11-10','2022-11-10','paid',340006),(9003,15100403,2000000.00,NULL,'2022-11-10','not paid',340003),(9004,NULL,2000.00,NULL,'2023-01-09','not paid',340003);
...
CREATE TABLE `online_loan_application` (
  ...
  PRIMARY KEY (`application_id`),
  KEY `online_loan_application_ibfk_3_idx` (`branch_code`),
  KEY `fk` (`fd_id`),
  KEY `online_loan_application_ibfk_2_idx` (`customer_id`),
  CONSTRAINT `fk` FOREIGN KEY (`fd_id`) REFERENCES `fixed_deposit` (`fd_id`),
  CONSTRAINT `online_loan_application_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE CASCADE,
  CONSTRAINT `online_loan_application_ibfk_3` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`)
) ENGINE=InnoDB AUTO_INCREMENT=2669 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `online_transaction` (
  `transaction_id` int NOT NULL AUTO_INCREMENT,
  `from_acc` bigint DEFAULT NULL,
  `to_acc` bigint DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  `transaction_time` datetime NOT NULL,
  PRIMARY KEY (`transaction_id`),
  KEY `online_transaction_fk_1` (`from_acc`),
  KEY `online_transaction_fk_2` (`to_acc`),
  CONSTRAINT `online_transaction_fk_1` FOREIGN KEY (`from_acc`) REFERENCES `account` (`account_no`),
  CONSTRAINT `online_transaction_fk_2` FOREIGN KEY (`to_acc`) REFERENCES `account` (`account_no`)
...
CREATE TABLE `organization_customer` (
  ...
  PRIMARY KEY (`customer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=340008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `savings_account` (
  ...
  PRIMARY KEY (`account_no`),
  KEY `savings_account_ibfk_1_idx` (`branch_code`),
  KEY `savings_account_ibfk_2_idx` (`customer_id`),
  CONSTRAINT `savings_account_ibfk_1` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`),
  CONSTRAINT `savings_account_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1810015010 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group2`@`%`*/ /*!50003 TRIGGER `savings_account_AFTER_INSERT` AFTER INSERT ON `savings_account` FOR EACH ROW BEGIN
	insert into account values (new.account_no,'savings');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `currentWithdraw`(in acc_no bigint, amount numeric(10,2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `debitAccount`(acc_no bigint,amount numeric(10,2))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `debitFromATM` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `debitFromATM`(atm_id int,acc_no bigint,amount numeric (10,2))
BEGIN
declare acc_type varchar(8);
declare cur_time datetime default current_timestamp();
declare exit handler FOR sqlexception
begin
rollback;
END;
...
start transaction;
	...
	call debitAccount(acc_no,amount);
    insert into atm_transaction(account_no,atm_id,amount,transaction_time,type) values (acc_no,atm_id,amount,cur_time,'deposit');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `savingsWithdraw`(in acc_no bigint, amount numeric(10,2))
BEGIN
	declare acc_balance numeric(10,2);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `transferOnline`(from_acc bigint,to_acc bigint,amount numeric(10,2))
BEGIN
	declare acc_type varchar(8);
...
start transaction;
    ...
    insert into online_transaction(from_acc,to_acc,amount,transaction_time) values (from_acc,to_acc,amount,time);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`group2`@`%` PROCEDURE `withdrawFromATM`(atm_id int,acc_no bigint,amount numeric (10,2))
BEGIN
declare acc_type varchar(8);
declare cur_time datetime default current_timestamp();
declare exit handler FOR sqlexception
...
start transaction;
    ...
    insert into atm_transaction(account_no,atm_id,amount,transaction_time,type) values (acc_no,atm_id,amount,cur_time,'withdrawl');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`group2`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `total_transaction` AS select `a`.`transaction_id` AS `tid`,`a`.`account_no` AS `from_acc`,NULL AS `to_account`,`a`.`amount` AS `amount`,`a`.`type` AS `type`,`a`.`transaction_time` AS `time` from `atm_transaction` `a` union select `o`.`transaction_id` AS `tid`,`o`.`from_acc` AS `from_acc`,`o`.`to_acc` AS `to_acc`,`o`.`amount` AS `amount`,'online' AS `type`,`o`.`transaction_time` AS `time` from `online_transaction` `o` order by `time` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-01-12 10:58:31
